...
if($_POST){
    ...
    if(empty($Nama_pegawai)){
        echo "<script>alert('nama pegawai tidak boleh kosong');location.href='tambah_siswa.php';</script>";


    } elseif(empty($No_tlp)){
        echo "<script>alert('No_tlp tidak boleh kosong');location.href='tambah_siswa.php';</script>";
    } elseif(empty($password)){
        echo "<script>alert('password tidak boleh kosong');location.href='tambah_siswa.php';</script>";
    } else {
        include "Koneksi.php";
        $insert=mysqli_query($conn,"insert into tabel_pegawai (Nik,Nama_pegawai, gender, alamat, No_tlp, password, id_pegawai)
